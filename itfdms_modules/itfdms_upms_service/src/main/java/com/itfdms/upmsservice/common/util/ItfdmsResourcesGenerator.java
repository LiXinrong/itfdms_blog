 ...
 * @Author: lxr
 * @CreateDate: 2018-08-28 22:35
 * @UpdateUser: lxr
 * @UpdateDate: 2018-08-28 22:35
 * @UpdateRemark: The modified content
 * @Version: 1.0
 **/
public class ItfdmsResourcesGenerator {


    public static void main(String[] args) {
        String outputDir = "F:/itfdms_blog/work";
        ...
        dsc.setUrl("jdbc:mysql://localhost/itfdms_blog?characterEncoding=utf8&serverTimezone=UTC&useSSL=false");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setSuperControllerClass("com.itfdms.common.web.BaseController");
        // 表名生成策略
        ...
        pc.setParent("com.itfdms.upmsservice");
